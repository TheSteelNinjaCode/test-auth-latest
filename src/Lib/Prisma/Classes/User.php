...
class User implements IModel
{
    ...
    protected function includeUserRole(array $items, array $selectedFields = [], array $includeSelectedFields = [], bool $format = false) 
    {
        ...
        $dbType = $this->_dbType;
        $quotedTableName = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"UserRole\"" : "`UserRole`";
        $tableName = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"Users\"" : "`Users`";
        $tableModelName = 'User';
        $tablePrimaryKey = 'id';
        $tablePrimaryKeyQuoted = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"id\"" : "`id`";
        $modelName = 'UserRole';
        ...
        $primaryKey = 'id';
        $foreignKey = 'roleId';
        $primaryKeyQuoted = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"id\"" : "`id`";
        $foreignKeyQuoted = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"roleId\"" : "`roleId`";
    ...
    public function create(array $data, bool $format = false): array | object 
    {
        ...
        $bindings = [];
        $dbType = $this->_dbType;
        $quotedTableName = ($dbType == 'pgsql' || $dbType == 'sqlite') ? "\"Users\"" : "`Users`";
